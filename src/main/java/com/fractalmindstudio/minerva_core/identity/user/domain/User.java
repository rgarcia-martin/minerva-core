...
public record User(
    ...
    public static final String FIELD_PASSWORD = "user.password";
    ...
    public User {
        ...
        email = DomainRules.requireNonBlank(email, FIELD_EMAIL);
        password = DomainRules.requireNonBlank(password, FIELD_PASSWORD);
    ...
    public static User create(
        ...
        return new User(UUID.randomUUID(), name, lastName, email, password, address, roles, true);
    }

    public User deactivate() {
        return new User(id, name, lastName, email, password, address, roles, false);
    }
}
